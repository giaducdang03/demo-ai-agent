...
if QDRANT_MODE == "local":
    ...
    QDRANT_CLIENT_CONFIG = {
        ...
        "api_key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIiwiZXhwIjoxNzQ2NTQzNDIxfQ.4RjMENvPWBPE0hVpJb5K4cTVlwzezPUHVJUPh5SU1LA",
    }
...
PROMPT_TEMPLATE = """Sử dụng ngữ cảnh dưới đây để trả lời câu hỏi cuối cùng.
Nếu không biết câu trả lời, hãy trả lời rằng bạn không biết.
